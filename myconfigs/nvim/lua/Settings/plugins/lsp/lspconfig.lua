return {
    ...
    config = function()
        ...
        vim.diagnostic.config({
            ...
            virtual_text = true,  -- Enable virtual text by default for diagnostics
        ...
        -- Language-specific LSP configurations are now managed separately
        -- in lua/Settings/languages/ directory
        -- This keeps only general-purpose LSP servers here
